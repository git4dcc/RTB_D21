...
The [D21](https://rtb4dcc.de/hardware/decoder/d21/) decoder is a double sided mobile decoder with Next18 (NEM-662) connector. The decoder is designed to integrate into the [RTB](https://rtb4dcc.de/concept/) digital control infrastructure.
